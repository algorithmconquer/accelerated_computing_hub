...
def visualize_results(target, initial_mask, optimized_mask, kernel):
    """
    可视化所有结果
    """
    print("\n" + "="*60)
...
def main():
    ...
    # 5. 可视化结果
    initial_wafer, optimized_wafer = visualize_results(target, initial_mask, optimized_mask, kernel)
